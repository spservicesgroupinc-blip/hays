  ...
  const processEstimate = async (fileObj: File | null, rawText?: string) => {
    ...
    try {
      ...
      const job: Job = result.job || {
        ...
        customerName: data.insuredName || 'Scott Swift',
        propertyAddress: data.propertyAddress || '8704 Alamasa Pl, Fort Wayne, IN 46835',
        phone: (data as any).phone || '(260) 414-8832',
        claimNumber: data.claimNumber || '0200042438',
        lossType: data.lossType || 'Water Damage',
        totalEstimate: data.totalEstimate || '$27,696.84',
        scopeSummary: data.unitArea || 'Main Level',
